...
import { Input, InputTextArea } from "./Inputs";
...
export default function InvoiceForm() {
  ...
  return (
    <form
      ...
      className="my-10 appMarginX   space-y-5 grid flex-col  xl:grid-cols-2">
      <div className="col-span-10 space-y-5 flex flex-col p-4 text bg-background">
        {/* flex 1 */}
      ...
      <div className="col-span-2">
        <Button
          type="submit"
          className="bg-customGreen rounded px-3 py-2 cursor-pointer hover:border hover:border-primary">
          <p>{isSubmitting ? "submitting.." : "downlaod"}</p>
        </Button>
      </div>
    </form>
  );
